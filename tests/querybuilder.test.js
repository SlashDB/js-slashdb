import { QueryBuilder, eq, any, between, gte, lte, not, and } from '../modules/querybuilder.js';
import { SDB_FILTER_ERR_INVALID_COL_NAME, SDB_FILTER_ERR_INVALID_NUM_ARGS, SDB_FILTER_ERR_INVALID_TYPE, SDB_FILTER_ERR_EMPTY_STRING, SDB_FILTER_ERR_INVALID_COMPARE_TYPE, SDB_FILTER_ERR_INVALID_RANGE, SDB_FILTER_ERR_NO_COL_FOUND } from '../modules/querybuilder.js';
import { SDB_SEPARATOR } from '../modules/querybuilder.js';
...
describe('Composable functions unit tests', () => {
    ...
    test('testing: multifunction usage', () => {
        ...
        let result;
        const expected = 'Customer/FirstName/A*/Country/Brazil/City/Brasília,São Paulo/Invoice/InvoiceData/2011-01-01../Customer/F*..J*/~BillingCountry/Brazil/InvoiceLine/Track';

        result = and(
                    eq('Customer/FirstName','A*'),
                    eq('Country','Brazil'),
                    any('City','Brasília','São Paulo').replaceAll(SDB_SEPARATOR,','),
                    gte('Invoice/InvoiceData','2011-01-01'),
