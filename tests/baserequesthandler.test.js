...
const testIf = (condition, ...args) =>
  ...
  beforeAll( () => {
    ...
    afterAll( async () => {
        ...
        try {
            let r = await fetchWrapper("DELETE", `${LIVE_SDB_HOST}/db/${SDB_TEST_DB_NAME}/Customer/FirstName/BaseRequestTestRecord`);
        }
        catch(e) {
            null;
        }
...
describe('BaseRequestHandler() class tests', () => {
    ...
    testIf(MOCK_TESTS_ENABLED, 'testing: get() mock tests', async () => {
     ...
     testIf(LIVE_TESTS_ENABLED, 'testing: get() live tests', async () => {
        ...
        try {
            let testBRH = new BaseRequestHandler(liveClient)
            await testBRH.get(`/db/${SDB_TEST_DB_NAME}/Customer/InvalidResource`);
        }
        catch(e) {
    ...
    testIf(LIVE_TESTS_ENABLED, 'testing: post() live tests', async () => {
        ...
        try {
            let testBRH = new BaseRequestHandler(liveClient);
            let r = await testBRH.post(newCustomer,`/db/${SDB_TEST_DB_NAME}/Customer`);
            expect(r.res.status).toBe(201)
        }
        catch(e) {
            throw Error(e)
        ...
        try {
            let testBRH = new BaseRequestHandler(liveClient);
            let r = await testBRH.post(newCustomer,`/db/${SDB_TEST_DB_NAME}/InvalidResource`);
        }
        catch(e) {
            expect(e.message).toBe('404');
        }
    ...
    testIf(LIVE_TESTS_ENABLED, 'testing: put() live tests', async () => {
        ...
        try {
            let testBRH = new BaseRequestHandler(liveClient);
            let r = await testBRH.put(`/db/${SDB_TEST_DB_NAME}/Customer/FirstName/BaseRequestTestRecord`, updateCustomer);            
        ...
        try {
            let testBRH = new BaseRequestHandler(liveClient); 
            let r = await testBRH.put(`/db/${SDB_TEST_DB_NAME}/InvalidResource`, updateCustomer);  
        }
        catch(e) {
            expect(e.message).toBe('404');
        }
        ...
        try {
            let testBRH = new BaseRequestHandler(liveClient); 
            let r = await testBRH.put(`/db/${SDB_TEST_DB_NAME}/Customer/InvalidColumn/BaseRequestTestRecord`, updateCustomer);  
        }
        catch(e) {
            expect(e.message).toBe('400');
        }
    ...
    testIf(LIVE_TESTS_ENABLED, 'testing: delete() live tests', async () => {
        ...
        try {
            let testBRH = new BaseRequestHandler(liveClient);
            let r = await testBRH.delete(`/db/${SDB_TEST_DB_NAME}/Customer/FirstName/BaseRequestTestRecord`);                    
            expect(r.res.status).toBe(204)
        }
        catch(e) {
            throw Error(e)
        ...
        try {
            let testBRH = new BaseRequestHandler(liveClient);
            await testBRH.delete(`/db/${SDB_TEST_DB_NAME}/InvalidResource`);   
        }
        catch(e) {
            expect(e.message).toBe('404');
        }
        ...
        try {
            let testBRH = new BaseRequestHandler(liveClient);
            await testBRH.delete(`/db/${SDB_TEST_DB_NAME}/Customer/InvalidResource`);   
        }
        catch(e) {
            expect(e.message).toBe('400');
        }
